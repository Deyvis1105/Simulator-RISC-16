...
namespace instructionSet {
    ...
    void andd(readASM::Instruction* i, readASM::ArchvASM archv);
    
    //*Función para aplicar el operador lógico or a nivel de bits.
    void orr(readASM::Instruction* i, readASM::ArchvASM archv);
    ...
    void cmp(readASM::Instruction* i, readASM::ArchvASM archv);

    //*Función para hacer un desplazamiento lógico a nivel de bit hacia la izquierda.
    void lsl(readASM::Instruction* i, readASM::ArchvASM archv);
    
    //*Función para hacer un desplazamiento lógico a nivel de bit hacia la derecha.
    void lsr(readASM::Instruction* i, readASM::ArchvASM archv);
